...
/*  PUTNO 1
    1.1. Realizar estructura basica html (h1, input te tipo texto, boton "buscar" y un boton "reset", listado de resultados donde tenemos el carte de la serie osea foto y el titulo)
